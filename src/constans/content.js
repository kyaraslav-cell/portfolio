...
const pl = {
  ...
  hero: {
    ...
    chips: [
      ...
      "Wdrożenie w wyposazamyrazem.pl",
  ...
  trust: {
    ...
    points: [
      ...
      { title: "Umowa powierzenia", body: "Art. 28 RODO. Podpisana, zanim dostanę dostęp do danych." },
  ...
  pricing: {
    ...
    rows: [
      { scope: "Jedna automatyzacja", detail: "Jeden proces, jedno źródło, jeden cel", price: "500 - 2 000 zł" },
      { scope: "Integracja sklep i ERP", detail: "Zamówienia, stany, dokumenty, obsługa błędów", price: "do 3 000 zł" },
      { scope: "System wieloetapowy z AI", detail: "Kilka źródeł, klasyfikacja, interfejs, monitoring", price: "do 4 000 zł" },
      { scope: "Utrzymanie i monitoring", detail: "Reakcja na awarie, zmiany w API dostawców", price: "2 miesiące gratis, potem 30 zł / mies." },
    ],
...
const en = {
  ...
  hero: {
    ...
    chips: [
      ...
      "Deployed at wyposazamyrazem.pl",
  ...
  trust: {
    ...
    points: [
      ...
      { title: "Processing agreement", body: "GDPR Article 28. Signed before I get access to any data." },
  ...
  pricing: {
    ...
    rows: [
      { scope: "A single automation", detail: "One process, one source, one destination", price: "500 - 2,000 PLN" },
      { scope: "Shop and ERP integration", detail: "Orders, stock, documents, error handling", price: "up to 3,000 PLN" },
      { scope: "Multi-step system with AI", detail: "Several sources, classification, interface, monitoring", price: "up to 4,000 PLN" },
      { scope: "Maintenance and monitoring", detail: "Response to failures, changes in vendor APIs", price: "Free for 2 months, then 30 PLN / month" },
    ],
